...
public:
    ...
    float  dlerror2D[MAX_XB];
    float  sigmaLvtxMag[MAX_XB];
    float  lvtxMag[MAX_XB];
    float  sigmaRvtxMag[MAX_XB];
    float  rvtxMag[MAX_XB];
    float  ip3d[MAX_XB];
